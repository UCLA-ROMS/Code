     ...
     &     + 3
      ...
      integer(kind=4) istr,iend, j, i, k
      real(kind=8) ratio(istr-2:iend+2,0:N), cff
...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &                 , g=9.81_8
      ...
      real(kind=8) Tt, Ts, Tp
      real(kind=8), parameter ::
     &       A0=+0.665157D-01,  A1=+0.170907D-01,  A2=-0.203814D-03,
     ...
     &                                             Smean=35.0_8
      do k=1,N-1
        do i=istr,iend
          Tt=0.5_8*(t(i,j,k,nstp,itemp)+t(i,j,k+1,nstp,itemp))
          Ts=0.5_8*(t(i,j,k,nstp,isalt)+t(i,j,k+1,nstp,isalt))
     &                                                -Smean
          Tp=-z_w(i,j,k)
