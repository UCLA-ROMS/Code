...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &     )
      ...
      integer(kind=4) ierr,  record, lstr, lvar, lenstr,itrc
     &   , start(2), count(2), ibuff(4), nf_fwrite
     &   ,varid
      REAL(kind=8),DIMENSION(-1:Lm+2+padd_X,-1:Mm+2+padd_E,1)::WORK
      call def_bec_flux_avg (ncid_bgc_flux_avg, nrec_bgc_flux_avg, ierr)
      if (ierr .ne. nf_noerr) goto 99
      lstr=lenstr(bgc_flux_avg_name)
      nrec_bgc_flux_avg=max(nrec_bgc_flux_avg,1)
      if (nrpf_bgc_flux_avg.eq.0) then
     ...
     &
      ...
      ierr=nf_fwrite (zeta_bgc_flux_avg(-1,-1),
     ...
     &
       ...
       itrc=1
          ierr=nf_fwrite(ws_avg(-1,-1), ncid_bgc_flux_avg,
     ...
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(xkw_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(ap_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(schmidt_o2_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
          ierr=nf_fwrite(o2sat_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(fg_o2_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fg_n2o_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fg_n2_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(denitr_sed_avg(-1,-1),
     &         ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(schmidt_co2_avg(-1,-1),ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(co2star_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(dco2star_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(fg_co2_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(iron_flux_avg(-1,-1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(PARinc_flux_avg(-1,-1),ncid_bgc_flux_avg,
     &      vid_bec_flux_avg(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_poc_avg(-1,-1),
     ...
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_caco3_avg(-1,-1),
     &      ncid_bgc_flux_avg, vid_bec_flux_avg(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_si_avg(-1,-1),
     &      ncid_bgc_flux_avg, vid_bec_flux_avg(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(po4_restore_avg(-1,-1,1),
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(no3_restore_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sio3_restore_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
        ierr=nf_fwrite(par_flux_avg(-1,-1,1),ncid_bgc_flux_avg,
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(po4star_avg(-1,-1,1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(poc_flux_in_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
          ierr=nf_fwrite(poc_prod_avg(-1,-1,1),
     &       ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(poc_remin_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(caco3_flux_in_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(caco3_prod_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(caco3_remin_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(sio2_flux_in_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
          ierr=nf_fwrite(sio2_prod_avg(-1,-1,1),
     &       ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sio2_remin_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(dust_flux_in_avg(-1,-1,1),
     &      ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
         ...
         itrc=itrc+1
         ierr=nf_fwrite(dust_remin_avg(-1,-1,1),
     &        ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(p_iron_flux_in_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
        ierr=nf_fwrite(p_iron_prod_avg(-1,-1,1),
     &       ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(p_iron_remin_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_tot_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_loss_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_loss_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(zoo_loss_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sp_agg_avg(-1,-1,1), ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_agg_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(f_ratio_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(f_ratio_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(tot_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(no3_v_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nh4_v_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(no3_v_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nh4_v_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(doc_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(doc_remin_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fe_scavenge_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_n_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_fe_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_po4_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_light_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_n_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_fe_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_po4_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_sio3_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_light_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(caco3_form_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_nfix_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_diaz_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_loss_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_diaz_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_p_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_fe_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_light_lim_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fe_scavenge_rate_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(don_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
           ierr=nf_fwrite(don_remin_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dofe_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dofe_remin_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dop_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
           ierr=nf_fwrite(dop_remin_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(bsi_form_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_diaz_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_diat_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_sp_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nitrif_avg(-1,-1,1),ncid_bgc_flux_avg,
     &                          vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(ammox_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(denitr_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(n2o_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(n2_prod_avg(-1,-1,1),
     &         ncid_bgc_flux_avg,vid_bec_flux_avg(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
 ...
 100  continue
      ...
      if (ierr .eq. nf_noerr) then
        if (mynode.eq.0) write(*,'(6x,A,2(A,I4,1x),A,I3)')
