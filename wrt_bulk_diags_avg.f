      ...
      integer(kind=4) ierr, record, lstr, lvar, lenstr
...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &     ierr)
      ...
      nrec_bulk_diags_avg=max(nrec_bulk_diags_avg,1)
     ...
     &
      ...
      ierr=nf_fwrite (zeta_bulk_diags_avg(-1,-1),
     ...
     &
       ...
       ierr=nf_fwrite(sustr_blk_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgSustr_blk, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(svstr_blk_avg(-1,-1),ncid_bulk_diags_avg,
     &                                        avgSvstr_blk, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(shflx_net_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgShflx_net, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(shflx_lat_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgShflx_lat, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(shflx_sen_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgShflx_sen, record,
     &                                                     r2dvar)
        ierr=nf_fwrite(shflx_rad_avg(-1,-1),ncid_bulk_diags_avg,
     &                                        avgShflx_rad, record,
     &                                                     r2dvar)
        ierr=nf_fwrite(swflx_emp_avg(-1,-1),ncid_bulk_diags_avg,
     &                                        avgSwflx_emp, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(shflx_wwk_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgShflx_wwk, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(surf_u_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgSurf_u, record,
     &                                                     r2dvar)
       ierr=nf_fwrite(surf_v_avg(-1,-1),ncid_bulk_diags_avg,
     &                                       avgSurf_v, record,
     &                                                     r2dvar)
