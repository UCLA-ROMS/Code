...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &   ,varid
      ...
      nrec_bgc_flux_his=max(nrec_bgc_flux_his,1)
     ...
     &
       ...
       itrc=1
          ierr=nf_fwrite(ws_hist(-1,-1), ncid_bgc_flux_his,
     ...
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(xkw_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(ap_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(schmidt_o2_hist(-1,-1),ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
          ierr=nf_fwrite(o2sat_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(fg_o2_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fg_n2o_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fg_n2_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(denitr_sed_hist(-1,-1),
     &         ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(schmidt_co2_hist(-1,-1),
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(co2star_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(dco2star_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(fg_co2_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(iron_flux_hist(-1,-1), ncid_bgc_flux_his,
     &                          vid_bec_flux_his(itrc), record, r2dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(PARinc(-1,-1), ncid_bgc_flux_his,
     &      vid_bec_flux_his(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_poc_hist(-1,-1),
     &      ncid_bgc_flux_his, vid_bec_flux_his(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_caco3_hist(-1,-1),
     &      ncid_bgc_flux_his, vid_bec_flux_his(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(bot_flux_si_hist(-1,-1),
     &      ncid_bgc_flux_his, vid_bec_flux_his(itrc), record, r2dvar)
       if (ierr .ne. nf_noerr) then
          lvar=lenstr(vname_bgcflux(1,itrc))
          write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &         ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(po4_restore_hist(-1,-1,1),
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(no3_restore_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sio3_restore_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(po4star_hist(-1,-1,1), ncid_bgc_flux_his,
     ...
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(poc_flux_in_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
        ierr=nf_fwrite(poc_prod_hist(-1,-1,1),
     &       ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(poc_remin_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(caco3_flux_in_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(caco3_prod_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(caco3_remin_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sio2_flux_in_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
        ierr=nf_fwrite(sio2_prod_hist(-1,-1,1),
     &       ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(sio2_remin_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
       ierr=nf_fwrite(dust_flux_in_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
         ...
         itrc=itrc+1
         ierr=nf_fwrite(dust_remin_hist(-1,-1,1),
     &        ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(p_iron_flux_in_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
        ...
        itrc=itrc+1
        ierr=nf_fwrite(p_iron_prod_hist(-1,-1,1),
     &       ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(p_iron_remin_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_tot_hist(-1,-1,1),
     &         ncid_bgc_flux_his, vid_bec_flux_his(itrc), record,r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_loss_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_loss_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(zoo_loss_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
       ...
       itrc=itrc+1
          ierr=nf_fwrite(sp_agg_hist(-1,-1,1),
     &      ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_agg_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(f_ratio_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(f_ratio_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(tot_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(no3_v_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nh4_v_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(no3_v_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nh4_v_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(doc_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(doc_remin_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fe_scavenge_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_n_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_fe_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_po4_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(sp_light_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_n_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_fe_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_po4_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_sio3_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diat_light_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(caco3_form_hist(-1,-1,1),
     &         ncid_bgc_flux_his, vid_bec_flux_his(itrc), record,r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_nfix_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(graze_diaz_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_loss_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photoc_diaz_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_p_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_fe_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(diaz_light_lim_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(fe_scavenge_rate_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(don_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
           ierr=nf_fwrite(don_remin_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dofe_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dofe_remin_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(dop_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
           ierr=nf_fwrite(dop_remin_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(bsi_form_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_diaz_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_diat_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(photofe_sp_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(nitrif_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(ammox_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(denitr_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(n2o_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
     &                      ierr
          ...
          itrc=itrc+1
          ierr=nf_fwrite(n2_prod_hist(-1,-1,1),
     &         ncid_bgc_flux_his,vid_bec_flux_his(itrc), record, r3dvar)
          if (ierr .ne. nf_noerr) then
            lvar=lenstr(vname_bgcflux(1,itrc))
            write(*,1) vname_bgcflux(1,itrc)(1:lvar), record,
