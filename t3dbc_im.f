...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &                                                              )
            t(istr-1,j,k,nnew,itrc)=(1._8-tau)*t(istr-1,j,k,nnew,itrc)
     &                                    +tau*t_west(j,k,itrc)
     ...
     &                                                              )
            t(iend+1,j,k,nnew,itrc)=(1._8-tau)*t(iend+1,j,k,nnew,itrc)
     &                                         +tau*t_east(j,k,itrc)
     ...
     &                                                              )
            t(i,jstr-1,k,nnew,itrc)=(1._8-tau)*t(i,jstr-1,k,nnew,itrc)
     ...
     &                                                              )
            t(i,jend+1,k,nnew,itrc)=(1._8-tau)*t(i,jend+1,k,nnew,itrc)
