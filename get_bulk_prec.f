...
C$OMP THREADPRIVATE(/priv_scalars/)
 ...
 100  ncid=ncidbulk(iblk)
     ...
     &                                   prec_ncycle, prec_rec, ierr)
            ...
            if (mynode.eq.0) write(*,1) 'the precipitations  
     &                         ',blkname(1:lstr)
