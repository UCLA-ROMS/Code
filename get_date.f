      ...
      integer(kind=4) year,hour, minute,sec, half, iday,imon, 
     &                            dstat,tstat,
     &        nday, lmonth(12), lday(31), len1, len2, len3, lenstr
      character(len=3)  ampm(0:1)
      character(len=9) day(0:6), month(12)
     ...
     &            'September', 'October  ', 'November ', 'December '/
      character(len=11) ctime*11, today*18, fmt*20, wkday*44
      hour=0
      minute=0
      sec=0
      nday=1
