      ...
      implicit none
      integer(kind=4) ncid, ierr, nf_ftype, lvar,lenstr
...
C$OMP THREADPRIVATE(/priv_scalars/)
     ...
     &                                                          dtfast)
      ...
      ierr=nf_put_att_double(ncid, nf_global, 'theta_s', nf_ftype, 1,
     &                                                        theta_s)
      ierr=nf_put_att_double(ncid, nf_global, 'theta_b', nf_ftype, 1,
     &                                                        theta_b)
      ierr=nf_put_att_double(ncid, nf_global, 'hc', nf_ftype, 1, hc)
      ierr=nf_put_att_double(ncid, nf_global, 'Cs_w',nf_ftype,N+1,Cs_w)
     ...
     &                                              'nondimensional')
      ...
      ierr=nf_put_att_text (ncid, nf_global, 'Zob_units',  5, 'meter')
      lvar=lenstr(srcs)
