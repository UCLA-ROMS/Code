     ...
     &     + 3
      ...
      real(kind=8), dimension (istr-2:iend+2,jstr-2:jend+2) :: alpha, 
     &                                beta
     ...
     &        V01=+1.02270D-4 ,  V02=-1.65460D-6 ,  W00=+4.8314D-4
      ...
      do j=jmin,jmax
        do i=imin,imax
          ...
          sqrtTs=sqrt(Ts)
          alpha(i,j)=-cff*( Q01+Tt*( 2._8*Q02+Tt*( 3._8*Q03+Tt*(
     &                                  4._8*Q04 +Tt*5._8*Q05 )))
     &                         +Ts*( U01+Tt*( 2._8*U02+Tt*(
     &                                     3._8*U03 +Tt*4._8*U04 ))
     &                                +sqrtTs*( V01+Tt*2._8*V02))
     &                                                       )
          beta(i,j)= cff*( U00+Tt*(U01+Tt*(U02+Tt*(U03+Tt*U04)))
     &            +1.5_8*(V00+Tt*(V01+Tt*V02))*sqrtTs+2._8*W00*Ts )
        enddo
      enddo
      return
      end
