     ...
     &     + 3
      ...
      real(kind=8) A(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      ...
      call mpi_exchange8_tile (istr,iend,jstr,jend, A,1)
      return
      end
     ...
     &     + 3
      ...
      call mpi_exchange8_tile (istr,iend,jstr,jend, A, nmaxA)
      return
      end
     ...
     &     + 3
      ...
      call mpi_exchange8_2_tile (istr,iend,jstr,jend, A,1, B,1)
      return
      end
     ...
     &     + 3
      ...
      call mpi_exchange8_2_tile (istr,iend,jstr,jend, A, nmaxA,
     &                                                B, nmaxB)
      return
      end
     ...
     &     + 3
      ...
      real(kind=8) A(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real(kind=8) B(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real(kind=8) C(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      integer(kind=4) istrU, istrR, iendR
      integer(kind=4) jstrV, jstrR, jendR
      if (istr.eq.iwest .and. .not.west_exchng) then
        istrR=istr-1
      ...
      call mpi_exchange8_3_tile (istr,iend,jstr,jend, A,1, B,1, C,1)
      return
      end
     ...
     &     + 3
      ...
      call mpi_exchange8_3_tile (istr,iend,jstr,jend, A, nmaxA,
     &                                      B, nmaxB, C, nmaxC)
      return
      end
     ...
     &     + 3
      ...
      real(kind=8) B(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real(kind=8) C(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      real(kind=8) D(-1:Lm+2+padd_X,-1:Mm+2+padd_E)
      integer(kind=4) istrU, istrR, iendR
      integer(kind=4) jstrV, jstrR, jendR
      if (istr.eq.iwest .and. .not.west_exchng) then
        istrR=istr-1
      ...
      call mpi_exchange8_4_tile (istr,iend,jstr,jend, A,1, B,1,
     &                                                C,1, D,1)
      return
      end
     ...
     &     + 3
      ...
      call mpi_exchange8_4_tile (istr,iend,jstr,jend, A, nmaxA,
     &                            B, nmaxB, C, nmaxC, D, nmaxD)
      return
      end
