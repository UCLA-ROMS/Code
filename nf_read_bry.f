      integer(kind=4) function nf_read_bry_EW (A, ncid, varid, record, 
     &                               type)
      implicit none
     ...
     &     + 3
      ...
      real(kind=8) A(0:Mm+1,N)
      integer(kind=4) ncid, varid, record, type,  i,j,k, kmax, shft,
     &                                    ierr, lstr, lenstr
     ...
     &        west_msg_exch,east_msg_exch, south_msg_exch,north_msg_exch
      ...
      include "mpif.h"
      integer(kind=4), parameter :: ibss=100000
      integer(kind=4) req(2), status(MPI_STATUS_SIZE,2)
      real(kind=8) bffr_rsv_S(N+1), bffr_snd_S(N+1),
     ...
     &                          'illegal grid type', type
      ...
      integer(kind=4) function nf_read_bry_NS (A, ncid, varid, record, 
     &                               type)
      implicit none
      integer(kind=4), parameter ::
     &               LLm=435, MMm=660, N=60
     ...
     &     + 3
      integer(kind=4), parameter :: NT=itemp+ntrc_salt+ntrc_pas+ntrc_bio
      real(kind=8) A(0:Lm+1,N)
      integer(kind=4) ncid, varid, record, type,  i, k, kmax, shft,
     &                                    ierr, lstr, lenstr
      character(len=16) vname
      integer(kind=4) nf_byte
      integer(kind=4) nf_int1
     ...
     &        west_msg_exch,east_msg_exch, south_msg_exch,north_msg_exch
      ...
      integer(kind=4), parameter :: ibss=100000
      integer(kind=4) req(2), status(MPI_STATUS_SIZE,2)
      real(kind=8) bffr_rsv_W(N+1), bffr_rsv_E(N+1),
